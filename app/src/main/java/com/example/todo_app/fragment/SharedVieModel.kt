...
import com.example.todo_app.data.model.Priority
import java.text.FieldPosition

class SharedVieModel(application: Application) : AndroidViewModel(application) {
    ...
    //variabel merubah warna prioritas
    ...
    //function untuk verifikasi data dari user
